...
func request_DataCollector_StartRecording_0(ctx context.Context, marshaler runtime.Marshaler, client DataCollectorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_DataCollector_StartRecording_0(ctx context.Context, marshaler runtime.Marshaler, server DataCollectorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RecordRequest
	var metadata runtime.ServerMetadata
...
func request_DataCollector_StopRecording_0(ctx context.Context, marshaler runtime.Marshaler, client DataCollectorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq StopRecRequest
	var metadata runtime.ServerMetadata
...
func local_request_DataCollector_StopRecording_0(ctx context.Context, marshaler runtime.Marshaler, server DataCollectorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq StopRecRequest
	var metadata runtime.ServerMetadata
...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterDataCollectorHandlerFromEndpoint instead.
func RegisterDataCollectorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DataCollectorServer) error {

	mux.Handle("POST", pattern_DataCollector_StartRecording_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/fmtrpc.DataCollector/StartRecording", runtime.WithHTTPPathPattern("/v1/start/recording"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DataCollector_StartRecording_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_DataCollector_StartRecording_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_DataCollector_StopRecording_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/fmtrpc.DataCollector/StopRecording", runtime.WithHTTPPathPattern("/v1/stop/recording"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DataCollector_StopRecording_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
// RegisterDataCollectorHandlerFromEndpoint is same as RegisterDataCollectorHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterDataCollectorHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterDataCollectorHandler(ctx, mux, conn)
}

// RegisterDataCollectorHandler registers the http handlers for service DataCollector to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterDataCollectorHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterDataCollectorHandlerClient(ctx, mux, NewDataCollectorClient(conn))
}

// RegisterDataCollectorHandlerClient registers the http handlers for service DataCollector
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "DataCollectorClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "DataCollectorClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "DataCollectorClient" to call the correct interceptors.
func RegisterDataCollectorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DataCollectorClient) error {

	mux.Handle("POST", pattern_DataCollector_StartRecording_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/fmtrpc.DataCollector/StartRecording", runtime.WithHTTPPathPattern("/v1/start/recording"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DataCollector_StartRecording_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_DataCollector_StopRecording_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/fmtrpc.DataCollector/StopRecording", runtime.WithHTTPPathPattern("/v1/stop/recording"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DataCollector_StopRecording_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
