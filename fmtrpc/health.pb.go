...
type HealthResponse struct {
	...
	State []HealthState `protobuf:"varint,1,rep,packed,name=state,proto3,enum=fmtrpc.HealthState" json:"state,omitempty"`
}
...
var file_health_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x3b, 0x0a, 0x0e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x29, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0e, 0x32, 0x13, 0x2e, 0x66, 0x6d, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x48, 0x65, 0x61, 0x6c,
	0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2a, 0x4d,
	...
	0x49, 0x43, 0x45, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x03, 0x32, 0x40, 0x0a,
...
var file_health_proto_goTypes = []interface{}{
	...
	(*HealthResponse)(nil), // 2: fmtrpc.HealthResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: fmtrpc.HealthResponse.state:type_name -> fmtrpc.HealthState
	1, // 1: fmtrpc.Health.Check:input_type -> fmtrpc.HealthRequest
	2, // 2: fmtrpc.Health.Check:output_type -> fmtrpc.HealthResponse
